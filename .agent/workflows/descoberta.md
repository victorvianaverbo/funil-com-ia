...
Antes de fechar a escolha, ajude o aluno a definir a faixa de preço do produto (consulte a skill `ref-precificacao`, seções "Como escolher a sua faixa" e "As 3 faixas de preço").

Avalie os 4 ativos do aluno, **uma pergunta de cada vez**:

1. "Você já tem audiência (seguidores, lista) que confia em você?"
2. "Você tem prova social — depoimentos, cases, resultados demonstráveis?"
3. "A transformação que você promete justifica um preço alto de forma crível?"
4. "Quanto você pode investir em tráfego de teste sem retorno imediato?"

Com as respostas, apresente a leitura: "Com esses ativos, a faixa mais indicada para começar é X, porque...". Lembre a regra: na dúvida entre duas faixas, comece pela menor.

Pergunte a DECISÃO: "Em qual faixa de preço você quer posicionar este produto: low ticket (R$27–97), ticket médio (R$197–997) ou high ticket (R$1.000+)?"

Ao registrar a escolha, alinhe a mentalidade da faixa (1 ponto, da `ref-precificacao`):
- **Low:** porta de entrada — equilíbrio de caixa e prova social valem mais que lucro imediato.
...
- **Produto de entrada:** o objetivo do primeiro produto é gerar clientes e prova social de forma sustentável — o faturamento cresce com a escada de valor, seja qual for a faixa de entrada.
